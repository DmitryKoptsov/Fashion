...
def train_one_epoch(model, optimizer, data_loader, device, epoch, train_writer,print_freq,run):
    model.train()
    ...
    for images, targets in tqdm(metric_logger.log_every(data_loader, print_freq, header)): 
        ...
        for name,value in loss_dict.items():
            train_writer.add_scalar(name, value, global_step=model_save_timer)
        ...
        if not math.isfinite(loss_value):
            continue  #Исправляем ошибку с loss_box_reg
